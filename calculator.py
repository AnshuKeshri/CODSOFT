...
Button(root,text="C",width=5,height=1,font=("arial",30,"bold"),bd=1,fg="white",bg="#36975f",command=lambda: clear()).place(x=10,y=100)
Button(root,text="/",width=5,height=1,font=("arial",30,"bold"),bd=1,fg="white",bg="black",command=lambda: show("/")).place(x=150,y=100)
Button(root,text="%",width=5,height=1,font=("arial",30,"bold"),bd=1,fg="white",bg="black",command=lambda: show("%")).place(x=290,y=100)
Button(root,text="*",width=5,height=1,font=("arial",30,"bold"),bd=1,fg="white",bg="black",command=lambda: show("*")).place(x=430,y=100)
...
Button(root,text="-",width=5,height=1,font=("arial",30,"bold"),bd=1,fg="white",bg="black",command=lambda: show("-")).place(x=430,y=200)
...
Button(root,text="+",width=5,height=1,font=("arial",30,"bold"),bd=1,fg="white",bg="black",command=lambda: show("+")).place(x=430,y=300)
